...
if (__HUSH_ENV == 'rc') {
    // TODO : add session handler for rc
...
// app host
$_APPCFG['app.host'] = 'http://hush-app.rc.focusgames.cn';
$_APPCFG['app.host.sdk'] = 'http://hush-app-sdk.rc.focusgames.cn';
$_APPCFG['app.host.admin'] = 'http://hush-app-admin.rc.focusgames.cn';

// static host
$_APPCFG['app.host.s'] = 'http://hush-app.rc.focusgames.cn';

// cdn host
$_APPCFG['app.cdn.url'] = 'http://hush-cdn.rc.focusgames.cn/hush-app/'.__APP_SITE;
