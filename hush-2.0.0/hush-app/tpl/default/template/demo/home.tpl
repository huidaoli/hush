    ...
    <div class="fz-layout-12">
      ...
      <div class="fz-layout-12">
        <div class="fz-card">
          ...
          <div class="fz-body">
            <div class="fz-txt">
            <p>1.分众传媒成立于2003年，2005年成为首家在</p>
            <p>2.美国纳斯达克上市的中国广告传媒</p>
            <p>3.股2015年回归A股市</p>
            <p>4.分众传媒将业务自电梯扩展至影院和卖场</p>
            <p>5.以超过5亿的核心用户数和90%以上的市场占有率</p>
            <p>6.成为城市社区场景广告的绝对王者</p>
            <p>7.中国最具品牌引爆力的媒体平台 </p>
            <p>8.分众游戏背靠分众传媒雄厚资源</p>
            </div>
          </div>
        </div>
      </div>
