...
require_once 'App/Dao/Core/User.php';
require_once 'App/Dao/Core/BpmFlow.php';
require_once 'App/Dao/Core/BpmNode.php';
require_once 'App/Dao/Core/BpmModel.php';
require_once 'App/Dao/Core/BpmRequestAudit.php';
require_once 'App/Paging.php';

/**
 * @package App_Dao_Core
 */
class Core_BpmRequest extends App_Dao_Core
{
	/**
	 * @static
	 */
	...
	public function getSendByPage ($uid)
	{
		...
		$pager = new Hush_Paging($total, $eachPageNum, null, array(
	...
	public function getDetails ($reqId)
	{
		...
		// get field name hash
		$bpmModelDao = App_Dao::load('Core_BpmModel');
